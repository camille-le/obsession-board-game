### General Comments
When using high `dpi` images, I ran into an issue where there is just too much noise.
This extra noise and texture made it really hard to detect the contour lines and crop.
Also, the operations to search for circles within the image were very expensive and 
